...
//// issue_handler.go
//func ProcessIssuesEvent(ctx context.Context, conf *config.Config, event *github.IssuesEvent) error {
//	installationID := event.GetInstallation().GetID()
//	client, err := newHandlerConfig(ctx, conf, installationID)
//	if err != nil {
//		return err
//	}
//
...
//		Body: &body,
//	}
//	if _, _, err := client.Issues.CreateComment(ctx, owner, repo, issueNumber, comment); err != nil {
//		return err
//	}
//
//	return nil
...
//func ProcessPullRequestsEvent(ctx context.Context, conf *config.Config, event *github.PullRequestEvent) error {
//	installationID := event.GetInstallation().GetID()
//	client, err := newHandlerConfig(ctx, conf, installationID)
//	if err != nil {
//		return err
